...
var initApp = (function(app) {
	...
	app.factoryReset = function () {
		...
		if (typeof bootbox  != 'undefined') {
			...
			bootbox.confirm({
				title: "<i class='" + myapp_config.appIconPrefix +  " fa-exclamation-triangle text-warning mr-2'></i> Resetiranje postavki sučelja",
				message: "Sve postavke korisničkog sučelja će se poništiti.",
				centerVertical: true,
			...
			if (confirm( 'Resetiraj postavke sučelja' )) {
				localStorage.clear();
				initApp.resetSettings();
				location.reload(true);
			}
